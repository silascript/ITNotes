...
这跟 [超悦](#超悦机场) 几乎一样。同样属于保底机场特性：价低量大，估计跟 [超悦](#超悦机场) 一样延迟会挺高。
...
> [!info] 
> 
> 有香港日本韩国节点，而且延迟也非常不错 -- 闲时，绿的节点很多，晚高峰还有是不少节点是绿的，比 [飞狗](#飞狗)、[Lemon](#Lemon) 要好很多。有 [VLess](#VLess) 和 [Hysteria2](#Hysteria) 两种协议。
>
...
这机场的节点协议有 [Vmess](#Vmess)、[Trojan](#Trojan)。不过延迟都挺高，八成节点都「红」了，没几个节点能用。
