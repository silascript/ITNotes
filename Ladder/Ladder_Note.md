...
[飞狗 ](https://1.mmcks.top) （[新域名](https://na.fgmcks.top)）有多款性价比套餐：
...
其他域名：[1.mmcks.top](https://1.mmcks.top)
...
[杜卡迪](https://www.dukadi.one) 性价比套餐：
...
> [!info] 
> 
> 中国大陆周边的节点有香港（4 个）、台湾（2 个）、日本（4 个）、新加坡（4 个），很不错。雷霆使用 [IEPL](#IEPL) 内网以及中国电信 [CN2](#CN2) ，所以延迟非常不错，晚高峰时段，大部分都还是绿的，并且延迟还低。不过节点是 [Shadowsocks](#Shadowsocks) 协议，有点老。
...
[Needay](https://needay.xyz) （[新域名](https://needay1.729388.xyz)）性价比套餐有蛮多款：
...
> [!info] 
> 
> 8 元，1000G，相当 1 元 125G，这比 [飞狗](#飞狗)5 元 500G 的不限时套还划算。
> 
